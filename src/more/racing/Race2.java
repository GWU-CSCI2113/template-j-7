...
class NewFrame2 extends JFrame {
	...
	void race() {
		...
		Zombie2 z1 = new Zombie2(1, drawingArea);
		Zombie2 z2 = new Zombie2(2, drawingArea);

		// Create a Thread instance for each zombie.
		// Note: the class Zombie2 must implement the
		// Runnable interface.
		Thread dThread1 = new Thread(z1);
		Thread dThread2 = new Thread(z2);
